...
DG_NGA_NB_COI_results <- numeric(num_simulations)
DG_NGA_NB_VSL_results <- numeric(num_simulations)
DG_NGA_NB_VSLY_results <- numeric(num_simulations)
...
DG_MWI_NB_COI_results <- numeric(num_simulations)
DG_MWI_NB_VSL_results <- numeric(num_simulations)
DG_MWI_NB_VSLY_results <- numeric(num_simulations)
...
DG_DRC_NB_COI_results <- numeric(num_simulations)
DG_DRC_NB_VSL_results <- numeric(num_simulations)
DG_DRC_NB_VSLY_results <- numeric(num_simulations)
...
DG_NB_COI_results <- numeric(num_simulations)
DG_NB_VSL_results <- numeric(num_simulations)
DG_NB_VSLY_results <- numeric(num_simulations)
...
Annualized_NGA_DG_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_NGA_DG_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_NGA_DG_vac_COI)){
  Annualized_NGA_DG_vac_COI[1,i] <- NPV_NGA_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_NGA_DG_vac_COI <- as.data.frame(Annualized_NGA_DG_vac_COI)
...
Annualized_MWI_DG_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_MWI_DG_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_MWI_DG_vac_COI)){
  Annualized_MWI_DG_vac_COI[1,i] <- NPV_MWI_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_MWI_DG_vac_COI <- as.data.frame(Annualized_MWI_DG_vac_COI)
...
Annualized_DRC_DG_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DRC_DG_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_DRC_DG_vac_COI)){
  Annualized_DRC_DG_vac_COI[1,i] <- NPV_DRC_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_DRC_DG_vac_COI <- as.data.frame(Annualized_DRC_DG_vac_COI)
...
Annualized_DG_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DG_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_DG_vac_COI)){
  Annualized_DG_vac_COI[1,i] <- NPV_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_DG_vac_COI <- as.data.frame(Annualized_DG_vac_COI)
...
Annualized_NGA_DG_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_NGA_DG_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_NGA_DG_vac_VSL)){
  Annualized_NGA_DG_vac_VSL[1,i] <- NPV_NGA_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_NGA_DG_vac_VSL <- as.data.frame(Annualized_NGA_DG_vac_VSL)
...
Annualized_MWI_DG_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_MWI_DG_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_MWI_DG_vac_VSL)){
  Annualized_MWI_DG_vac_VSL[1,i] <- NPV_MWI_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_MWI_DG_vac_VSL <- as.data.frame(Annualized_MWI_DG_vac_VSL)
...
Annualized_DRC_DG_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DRC_DG_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_DRC_DG_vac_VSL)){
  Annualized_DRC_DG_vac_VSL[1,i] <- NPV_DRC_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_DRC_DG_vac_VSL <- as.data.frame(Annualized_DRC_DG_vac_VSL)
...
Annualized_DG_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DG_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_DG_vac_VSL)){
  Annualized_DG_vac_VSL[1,i] <- NPV_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_DG_vac_VSL <- as.data.frame(Annualized_DG_vac_VSL)
...
Annualized_NGA_DG_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_NGA_DG_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_NGA_DG_vac_VSLY)){
  Annualized_NGA_DG_vac_VSLY[1,i] <- NPV_NGA_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_NGA_DG_vac_VSLY <- as.data.frame(Annualized_NGA_DG_vac_VSLY)
...
Annualized_MWI_DG_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_MWI_DG_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_MWI_DG_vac_VSLY)){
  Annualized_MWI_DG_vac_VSLY[1,i] <- NPV_MWI_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_MWI_DG_vac_VSLY <- as.data.frame(Annualized_MWI_DG_vac_VSLY)
...
Annualized_DRC_DG_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DRC_DG_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_DRC_DG_vac_VSLY)){
  Annualized_DRC_DG_vac_VSLY[1,i] <- NPV_DRC_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_DRC_DG_vac_VSLY <- as.data.frame(Annualized_DRC_DG_vac_VSLY)
...
Annualized_DG_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DG_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_DG_vac_VSLY)){
  Annualized_DG_vac_VSLY[1,i] <- NPV_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_DG_vac_VSLY <- as.data.frame(Annualized_DG_vac_VSLY)
...
##################### Vaccine Spoilage rates inputs for alternate###########################################################################
#Vaccination spoilage rate; source : GAVI Detailed Product Profiles (DPPs) for WHO prequalified vaccines
...
vac_spoilage_NGA_HepA_Hib_new <- runif(1,(1-wastage_rate_reduction_max)*0.05,(1-wastage_rate_reduction_min)*0.05) 
vac_spoilage_MWI_HepA_Hib_new <- runif(1,(1-wastage_rate_reduction_max)*0.05,(1-wastage_rate_reduction_min)*0.05)
vac_spoilage_DRC_HepA_Hib_new <- runif(1,(1-wastage_rate_reduction_max)*0.05,(1-wastage_rate_reduction_min)*0.05)

vac_spoilage_NGA_HPV_new <- runif(1,(1-wastage_rate_reduction_max)*0.07,(1-wastage_rate_reduction_min)*0.07)
vac_spoilage_MWI_HPV_new <- runif(1,(1-wastage_rate_reduction_max)*0.07,(1-wastage_rate_reduction_min)*0.07)
vac_spoilage_DRC_HPV_new <- runif(1,(1-wastage_rate_reduction_max)*0.07,(1-wastage_rate_reduction_min)*0.07)

vac_spoilage_NGA_MR_new <- runif(1,(1-wastage_rate_reduction_max)*0.25,(1-wastage_rate_reduction_min)*0.25)
vac_spoilage_MWI_MR_new <- runif(1,(1-wastage_rate_reduction_max)*0.25,(1-wastage_rate_reduction_min)*0.25)
vac_spoilage_DRC_MR_new <- runif(1,(1-wastage_rate_reduction_max)*0.25,(1-wastage_rate_reduction_min)*0.25)

vac_spoilage_NGA_PCV_new <- runif(1,(1-wastage_rate_reduction_max)*0.08,(1-wastage_rate_reduction_min)*0.08)
vac_spoilage_MWI_PCV_new <- runif(1,(1-wastage_rate_reduction_max)*0.08,(1-wastage_rate_reduction_min)*0.08)
vac_spoilage_DRC_PCV_new <- runif(1,(1-wastage_rate_reduction_max)*0.08,(1-wastage_rate_reduction_min)*0.08)

vac_spoilage_NGA_MenA_new <- runif(1,(1-wastage_rate_reduction_max)*0.40,(1-wastage_rate_reduction_min)*0.40)
vac_spoilage_MWI_MenA_new <- runif(1,(1-wastage_rate_reduction_max)*0.40,(1-wastage_rate_reduction_min)*0.40)
vac_spoilage_DRC_MenA_new <- runif(1,(1-wastage_rate_reduction_max)*0.40,(1-wastage_rate_reduction_min)*0.40)

vac_spoilage_NGA_Rota_new <- runif(1,(1-wastage_rate_reduction_max)*0.06,(1-wastage_rate_reduction_min)*0.06)
vac_spoilage_MWI_Rota_new <- runif(1,(1-wastage_rate_reduction_max)*0.06,(1-wastage_rate_reduction_min)*0.06)
vac_spoilage_DRC_Rota_new <- runif(1,(1-wastage_rate_reduction_max)*0.06,(1-wastage_rate_reduction_min)*0.06)

vac_spoilage_NGA_YF_new <- runif(1,(1-wastage_rate_reduction_max)*0.25,(1-wastage_rate_reduction_min)*0.25)
vac_spoilage_MWI_YF_new <- runif(1,(1-wastage_rate_reduction_max)*0.25,(1-wastage_rate_reduction_min)*0.25)
vac_spoilage_DRC_YF_new <- runif(1,(1-wastage_rate_reduction_max)*0.25,(1-wastage_rate_reduction_min)*0.25)

spoilage_change_NGA_HepA_Hib <- 0.05 - vac_spoilage_NGA_HepA_Hib_new
spoilage_change_MWI_HepA_Hib <- 0.05 - vac_spoilage_MWI_HepA_Hib_new
spoilage_change_DRC_HepA_Hib <- 0.05 - vac_spoilage_DRC_HepA_Hib_new

spoilage_change_NGA_HPV <- 0.07 - vac_spoilage_NGA_HPV_new
spoilage_change_MWI_HPV <- 0.07 - vac_spoilage_MWI_HPV_new
spoilage_change_DRC_HPV <- 0.07 - vac_spoilage_DRC_HPV_new

spoilage_change_NGA_MR <- 0.25 - vac_spoilage_NGA_MR_new
spoilage_change_MWI_MR <- 0.25 - vac_spoilage_MWI_MR_new
spoilage_change_DRC_MR <- 0.25 - vac_spoilage_DRC_MR_new

spoilage_change_NGA_PCV <- 0.08 - vac_spoilage_NGA_PCV_new
spoilage_change_MWI_PCV <- 0.08 - vac_spoilage_MWI_PCV_new
spoilage_change_DRC_PCV <- 0.08 - vac_spoilage_DRC_PCV_new

spoilage_change_NGA_MenA <- 0.40 - vac_spoilage_NGA_MenA_new
spoilage_change_MWI_MenA <- 0.40 - vac_spoilage_MWI_MenA_new
spoilage_change_DRC_MenA <- 0.40 - vac_spoilage_DRC_MenA_new

spoilage_change_NGA_Rota <- 0.06 - vac_spoilage_NGA_Rota_new
spoilage_change_MWI_Rota <- 0.06 - vac_spoilage_MWI_Rota_new
spoilage_change_DRC_Rota <- 0.06 - vac_spoilage_DRC_Rota_new

spoilage_change_NGA_YF <- 0.25 - vac_spoilage_NGA_YF_new
spoilage_change_MWI_YF <- 0.25 - vac_spoilage_MWI_YF_new
spoilage_change_DRC_YF <- 0.25 - vac_spoilage_DRC_YF_new

new_vaccine_rate_switch <- 0
old_vaccine_rate_switch <- 1
  
vac_spoilage_NGA_HepA_Hib <- vac_spoilage_NGA_HepA_Hib_new*new_vaccine_rate_switch + 0.05*old_vaccine_rate_switch
vac_spoilage_MWI_HepA_Hib <- vac_spoilage_NGA_HepA_Hib_new*new_vaccine_rate_switch + 0.05*old_vaccine_rate_switch  
vac_spoilage_DRC_HepA_Hib <- vac_spoilage_NGA_HepA_Hib_new*new_vaccine_rate_switch + 0.05*old_vaccine_rate_switch

vac_spoilage_NGA_HPV <- vac_spoilage_NGA_HPV_new*new_vaccine_rate_switch + 0.07*old_vaccine_rate_switch
vac_spoilage_MWI_HPV <- vac_spoilage_MWI_HPV_new*new_vaccine_rate_switch + 0.07*old_vaccine_rate_switch
vac_spoilage_DRC_HPV <- vac_spoilage_DRC_HPV_new*new_vaccine_rate_switch + 0.07*old_vaccine_rate_switch

vac_spoilage_NGA_MR <- vac_spoilage_NGA_MR_new*new_vaccine_rate_switch + 0.25*old_vaccine_rate_switch
vac_spoilage_MWI_MR <- vac_spoilage_MWI_MR_new*new_vaccine_rate_switch + 0.25*old_vaccine_rate_switch
vac_spoilage_DRC_MR <- vac_spoilage_DRC_MR_new*new_vaccine_rate_switch + 0.25*old_vaccine_rate_switch

vac_spoilage_NGA_PCV <- vac_spoilage_NGA_PCV_new*new_vaccine_rate_switch + 0.08*old_vaccine_rate_switch
vac_spoilage_MWI_PCV <- vac_spoilage_MWI_PCV_new*new_vaccine_rate_switch + 0.08*old_vaccine_rate_switch
vac_spoilage_DRC_PCV <- vac_spoilage_DRC_PCV_new*new_vaccine_rate_switch + 0.08*old_vaccine_rate_switch

vac_spoilage_NGA_MenA <- vac_spoilage_NGA_MenA_new*new_vaccine_rate_switch + 0.40*old_vaccine_rate_switch
vac_spoilage_MWI_MenA <- vac_spoilage_MWI_MenA_new*new_vaccine_rate_switch + 0.40*old_vaccine_rate_switch
vac_spoilage_DRC_MenA <- vac_spoilage_DRC_MenA_new*new_vaccine_rate_switch + 0.40*old_vaccine_rate_switch

vac_spoilage_NGA_Rota <- vac_spoilage_NGA_Rota_new*new_vaccine_rate_switch + 0.06*old_vaccine_rate_switch
vac_spoilage_MWI_Rota <- vac_spoilage_MWI_Rota_new*new_vaccine_rate_switch + 0.06*old_vaccine_rate_switch
vac_spoilage_DRC_Rota <- vac_spoilage_DRC_Rota_new*new_vaccine_rate_switch + 0.06*old_vaccine_rate_switch

vac_spoilage_NGA_YF <- vac_spoilage_NGA_YF_new*new_vaccine_rate_switch + 0.25*old_vaccine_rate_switch
vac_spoilage_MWI_YF <- vac_spoilage_MWI_YF_new*new_vaccine_rate_switch + 0.25*old_vaccine_rate_switch
vac_spoilage_DRC_YF <- vac_spoilage_DRC_YF_new*new_vaccine_rate_switch + 0.25*old_vaccine_rate_switch
...
Nigeria_vac_COI[i,1] <- Nigeria_pop$`Nigeria_New_born(million)`[i]* (vac_coverage_NGA_HepA_Hib)*(1+spoilage_change_NGA_HepA_Hib)* vac_recommended_dose_HepA_Hib*vac_COI_NGA_HepA_HiB
Malawi_vac_COI[i,1] <- Malawi_pop$`Malawi_New_born(million)`[i]* (vac_coverage_MWI_HepA_Hib)*(1+spoilage_change_MWI_HepA_Hib)*vac_recommended_dose_HepA_Hib *vac_COI_MWI_HepA_HiB
DRC_vac_COI[i,1] <- DRC_pop$`DRC_New_born(million)`[i]* (vac_coverage_DRC_HepA_Hib)*(1+spoilage_change_MWI_HepA_Hib)*vac_recommended_dose_HepA_Hib *vac_COI_DRC_HepA_HiB
Total_vac_COI [i,1] <- Nigeria_vac_COI[i,1] + Malawi_vac_COI[i,1] + DRC_vac_COI[i,1]
...
#HPV#
  ...
  Nigeria_vac_COI[i, 2] = Nigeria_pop$`Nigeria_Female_10to14(million)`[i] * vac_coverage_NGA_HPV_calc*(1+spoilage_change_NGA_HPV)* vac_recommended_dose_HPV * vac_COI_NGA_HPV
  ...
  Malawi_vac_COI[i, 2] = Malawi_pop$`Malawi_Female_10to14(million)`[i] * vac_coverage_MWI_HPV_calc*(1+spoilage_change_MWI_HPV) * vac_recommended_dose_HPV * vac_COI_MWI_HPV
  ...
  DRC_vac_COI[i, 2] = DRC_pop$`DRC_Female_10to14(million)`[i] * vac_coverage_DRC_HPV_calc*(1+spoilage_change_DRC_HPV) * vac_recommended_dose_HPV * vac_COI_DRC_HPV

  Total_vac_COI [i,2] <- Nigeria_vac_COI[i,2] + Malawi_vac_COI[i,2] + DRC_vac_COI[i,2]
  
#Measles and Rubella#

  Nigeria_vac_COI [i,3] = Nigeria_pop$`Nigeria_New_born(million)`[i]*(vac_coverage_NGA_MR)*(1+spoilage_change_NGA_MR)*vac_recommended_dose_MR*vac_COI_NGA_MR
  
  Malawi_vac_COI [i,3] = Malawi_pop$`Malawi_New_born(million)`[i]*(vac_coverage_MWI_MR)*(1+spoilage_change_MWI_MR)*vac_recommended_dose_MR*vac_COI_MWI_MR
  
  DRC_vac_COI [i,3] = DRC_pop$`DRC_New_born(million)`[i]*(vac_coverage_DRC_MR)*(1+spoilage_change_DRC_MR)*vac_recommended_dose_MR*vac_COI_DRC_MR
  
   Total_vac_COI [i,3] <- Nigeria_vac_COI[i,3] + Malawi_vac_COI[i,3] + DRC_vac_COI[i,3]

#PCV#

  Nigeria_vac_COI [i,4] = Nigeria_pop$`Nigeria_New_born(million)`[i]*(vac_coverage_NGA_PCV)*(1+spoilage_change_NGA_PCV)*vac_recommended_dose_PCV*vac_COI_NGA_PCV
  
  Malawi_vac_COI [i,4] = Malawi_pop$`Malawi_New_born(million)`[i]*(vac_coverage_MWI_PCV)*(1+spoilage_change_MWI_PCV)*vac_recommended_dose_PCV*vac_COI_MWI_PCV
  
  DRC_vac_COI [i,4] = DRC_pop$`DRC_New_born(million)`[i]*(vac_coverage_DRC_PCV)*(1+spoilage_change_DRC_PCV)*vac_recommended_dose_PCV*vac_COI_DRC_PCV
...
#Menningitis A#
  ...
  Nigeria_vac_COI[i, 5] = Nigeria_pop$`Nigeria_New_born(million)`[i] * vac_coverage_NGA_MenA_calc *(1+spoilage_change_NGA_MenA)* vac_recommended_dose_MenA * vac_COI_NGA_MenA
  
  Malawi_vac_COI[i, 5] = Malawi_pop$`Malawi_New_born(million)`[i] * vac_coverage_MWI_MenA*(1+spoilage_change_NGA_MenA) * vac_recommended_dose_MenA * vac_COI_MWI_MenA
  
DRC_vac_COI[i, 5] = DRC_pop$`DRC_New_born(million)`[i] * vac_coverage_DRC_MenA*(1+spoilage_change_NGA_MenA) * vac_recommended_dose_MenA * vac_COI_DRC_MenA
...
#Rota#
  ...
  Nigeria_vac_COI[i, 6] = Nigeria_pop$`Nigeria_New_born(million)`[i] * vac_coverage_NGA_Rota_calc*(1+spoilage_change_NGA_Rota) * vac_recommended_dose_Rota * vac_COI_NGA_Rota
  
  Malawi_vac_COI[i, 6] = Malawi_pop$`Malawi_New_born(million)`[i] * vac_coverage_MWI_Rota*(1+spoilage_change_MWI_Rota) * vac_recommended_dose_Rota_MWI * vac_COI_MWI_Rota
  
  DRC_vac_COI[i, 6] = DRC_pop$`DRC_New_born(million)`[i] * vac_coverage_DRC_Rota*(1+spoilage_change_DRC_Rota) * vac_recommended_dose_Rota * vac_COI_DRC_Rota
  
  Total_vac_COI [i,6] <- Nigeria_vac_COI[i,6] + Malawi_vac_COI[i,6] + DRC_vac_COI[i,6]

#Yellow Fever#

  Nigeria_vac_COI [i,7] = Nigeria_pop$`Nigeria_New_born(million)`[i]*(vac_coverage_NGA_YF)*(1+spoilage_change_NGA_YF)*vac_recommended_dose_YF*vac_COI_NGA_YF
  
  Malawi_vac_COI [i,7] = Malawi_pop$`Malawi_New_born(million)`[i]*(vac_coverage_MWI_YF)*(1+spoilage_change_MWI_YF)*vac_recommended_dose_YF*vac_COI_MWI_YF
  
  DRC_vac_COI [i,7] = DRC_pop$`DRC_New_born(million)`[i]*(vac_coverage_DRC_YF)*(1+spoilage_change_DRC_YF)*vac_recommended_dose_YF*vac_COI_DRC_YF 
...
Annualized_NGA_ALT_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_NGA_ALT_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_NGA_ALT_vac_COI)){
  Annualized_NGA_ALT_vac_COI[1,i] <- NPV_NGA_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_NGA_ALT_vac_COI <- as.data.frame(Annualized_NGA_ALT_vac_COI)
...
Annualized_MWI_ALT_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_MWI_ALT_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_MWI_ALT_vac_COI)){
  Annualized_MWI_ALT_vac_COI[1,i] <- NPV_MWI_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_MWI_ALT_vac_COI <- as.data.frame(Annualized_MWI_ALT_vac_COI)
...
Annualized_DRC_ALT_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DRC_ALT_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_DRC_ALT_vac_COI)){
  Annualized_DRC_ALT_vac_COI[1,i] <- NPV_DRC_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_DRC_ALT_vac_COI <- as.data.frame(Annualized_DRC_ALT_vac_COI)
...
Annualized_ALT_vac_COI <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_ALT_vac_COI) <- c("Annualized_VacCOI_HepA&HiB", "Annualized_VacCOI_HPV","Annualized_VacCOI_MR","Annualized_VacCOI_PCV","Annualized_VacCOI_Meningitis","Annualized_VacCOI_Rotavirus","Annualized_VacCOI_YF","Annualized_VacCOI_Overall")
for (i in 1: ncol(Annualized_ALT_vac_COI)){
  Annualized_ALT_vac_COI[1,i] <- NPV_vac_COI [1,i]/vaccine_annuity_factor
}

Annualized_ALT_vac_COI <- as.data.frame(Annualized_ALT_vac_COI)
...
for (i in 1:vac_estimation_length){
  ...
  Nigeria_vac_VSL[i,1] <- current_variation_NGA$`NGA_HepA&HiB`[i]* (1+spoilage_change_NGA_HepA_Hib)*NGA_VSL
  Nigeria_vac_VSL[i,2] <- current_variation_NGA$NGA_HPV[i]* (1+spoilage_change_NGA_HPV)*NGA_VSL
  Nigeria_vac_VSL[i,3] <- current_variation_NGA$NGA_MR[i]* (1+spoilage_change_NGA_MR)*NGA_VSL
  Nigeria_vac_VSL[i,4] <- current_variation_NGA$NGA_PCV[i]* (1+spoilage_change_NGA_PCV)*NGA_VSL
  Nigeria_vac_VSL[i,5] <- current_variation_NGA$NGA_Meningitis[i]* (1+spoilage_change_NGA_MenA)*NGA_VSL
  Nigeria_vac_VSL[i,6] <- current_variation_NGA$NGA_Rotavirus[i]* (1+spoilage_change_NGA_Rota)*NGA_VSL
  Nigeria_vac_VSL[i,7] <- current_variation_NGA$NGA_YF[i]* (1+spoilage_change_NGA_YF)*NGA_VSL
}
...
for (i in 1:vac_estimation_length){
  ...
  Malawi_vac_VSL[i,1] <- current_variation_MWI$`MWI_HepA&HiB`[i]* (1+spoilage_change_MWI_HepA_Hib)*MWI_VSL
  Malawi_vac_VSL[i,2] <- current_variation_MWI$MWI_HPV[i]*(1+spoilage_change_MWI_HPV)*MWI_VSL
  Malawi_vac_VSL[i,3] <- current_variation_MWI$MWI_MR[i]*(1+spoilage_change_MWI_MR)*MWI_VSL
  Malawi_vac_VSL[i,4] <- current_variation_MWI$MWI_PCV[i]*(1+spoilage_change_MWI_PCV)*MWI_VSL
  Malawi_vac_VSL[i,5] <- current_variation_MWI$MWI_Meningitis[i]* (1+spoilage_change_MWI_MenA)*MWI_VSL
  Malawi_vac_VSL[i,6] <- current_variation_MWI$MWI_Rotavirus[i]* (1+spoilage_change_MWI_Rota)*MWI_VSL
  Malawi_vac_VSL[i,7] <- current_variation_MWI$MWI_YF[i]* (1+spoilage_change_MWI_YF)*MWI_VSL
}
...
for (i in 1:vac_estimation_length){
  ...
  DRC_vac_VSL[i,1] <- current_variation_DRC$`DRC_HepA&HiB`[i]* (1+spoilage_change_DRC_HepA_Hib)*DRC_VSL
  DRC_vac_VSL[i,2] <- current_variation_DRC$DRC_HPV[i]* (1+spoilage_change_DRC_HPV)*DRC_VSL
  DRC_vac_VSL[i,3] <- current_variation_DRC$DRC_MR[i]* (1+spoilage_change_DRC_MR)*DRC_VSL
  DRC_vac_VSL[i,4] <- current_variation_DRC$DRC_PCV[i]* (1+spoilage_change_DRC_PCV)*DRC_VSL
  DRC_vac_VSL[i,5] <- current_variation_DRC$DRC_Meningitis[i]* (1+spoilage_change_DRC_MenA)*DRC_VSL
  DRC_vac_VSL[i,6] <- current_variation_DRC$DRC_Rotavirus[i]* (1+spoilage_change_DRC_Rota)*DRC_VSL
  DRC_vac_VSL[i,7] <- current_variation_DRC$DRC_YF[i]* (1+spoilage_change_DRC_YF)*DRC_VSL
}
...
Annualized_NGA_ALT_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_NGA_ALT_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_NGA_ALT_vac_VSL)){
  Annualized_NGA_ALT_vac_VSL[1,i] <- NPV_NGA_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_NGA_ALT_vac_VSL <- as.data.frame(Annualized_NGA_ALT_vac_VSL)
...
Annualized_MWI_ALT_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_MWI_ALT_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_MWI_ALT_vac_VSL)){
  Annualized_MWI_ALT_vac_VSL[1,i] <- NPV_MWI_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_MWI_ALT_vac_VSL <- as.data.frame(Annualized_MWI_ALT_vac_VSL)
...
Annualized_DRC_ALT_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DRC_ALT_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_DRC_ALT_vac_VSL)){
  Annualized_DRC_ALT_vac_VSL[1,i] <- NPV_DRC_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_DRC_ALT_vac_VSL <- as.data.frame(Annualized_DRC_ALT_vac_VSL)
...
Annualized_ALT_vac_VSL <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_ALT_vac_VSL) <- c("Annualized_VacVSL_HepA&HiB", "Annualized_VacVSL_HPV","Annualized_VacVSL_MR","Annualized_VacVSL_PCV","Annualized_VacVSL_Meningitis","Annualized_VacVSL_Rotavirus","Annualized_VacVSL_YF","Annualized_VacVSL_Overall")
for (i in 1: ncol(Annualized_ALT_vac_VSL)){
  Annualized_ALT_vac_VSL[1,i] <- NPV_vac_VSL [1,i]/vaccine_annuity_factor
}

Annualized_ALT_vac_VSL <- as.data.frame(Annualized_ALT_vac_VSL)
...
for (i in 1:vac_estimation_length){
  ...
  Nigeria_vac_VSLY[i,1] <- current_DALY_var_NGA$`NGA_HepA&HiB`[i]* (1+spoilage_change_NGA_HepA_Hib)*VSLY_data[1,1]
  Nigeria_vac_VSLY[i,2] <- current_DALY_var_NGA$NGA_HPV[i]* (1+spoilage_change_NGA_HPV)*VSLY_data[1,2]
  Nigeria_vac_VSLY[i,3] <- current_DALY_var_NGA$NGA_MR[i]* (1+spoilage_change_NGA_MR)*VSLY_data[1,3]
  Nigeria_vac_VSLY[i,4] <- current_DALY_var_NGA$NGA_PCV[i]* (1+spoilage_change_NGA_PCV)*VSLY_data[1,4]
  Nigeria_vac_VSLY[i,5] <- current_DALY_var_NGA$NGA_Meningitis[i]* (1+spoilage_change_NGA_MenA)*VSLY_data[1,5]
  Nigeria_vac_VSLY[i,6] <- current_DALY_var_NGA$NGA_Rotavirus[i]* (1+spoilage_change_NGA_Rota)*VSLY_data[1,6]
  Nigeria_vac_VSLY[i,7] <- current_DALY_var_NGA$NGA_YF[i]* (1+spoilage_change_NGA_YF)*VSLY_data[1,7]
}
...
for (i in 1:vac_estimation_length){
  ...
  Malawi_vac_VSLY[i,1] <- current_DALY_var_MWI$`MWI_HepA&HiB`[i]* (1+spoilage_change_MWI_HepA_Hib)*VSLY_data[2,1]
  Malawi_vac_VSLY[i,2] <- current_DALY_var_MWI$MWI_HPV[i]* (1+spoilage_change_MWI_HPV)*VSLY_data[2,2]
  Malawi_vac_VSLY[i,3] <- current_DALY_var_MWI$MWI_MR[i]* (1+spoilage_change_MWI_MR)*VSLY_data[2,3]
  Malawi_vac_VSLY[i,4] <- current_DALY_var_MWI$MWI_PCV[i]* (1+spoilage_change_MWI_PCV)*VSLY_data[2,4]
  Malawi_vac_VSLY[i,5] <- current_DALY_var_MWI$MWI_Meningitis[i]* (1+spoilage_change_MWI_MenA)*VSLY_data[2,5]
  Malawi_vac_VSLY[i,6] <- current_DALY_var_MWI$MWI_Rotavirus[i]* (1+spoilage_change_MWI_Rota)*VSLY_data[2,6]
  Malawi_vac_VSLY[i,7] <- current_DALY_var_MWI$MWI_YF[i]* (1+spoilage_change_MWI_YF)*VSLY_data[2,7]
}
...
for (i in 1:vac_estimation_length){
  ...
  DRC_vac_VSLY[i,1] <- current_DALY_var_DRC$`DRC_HepA&HiB`[i]* (1+spoilage_change_DRC_HepA_Hib)*VSLY_data[3,1]
  DRC_vac_VSLY[i,2] <- current_DALY_var_DRC$DRC_HPV[i]* (1+spoilage_change_DRC_HPV)*VSLY_data[3,2]
  DRC_vac_VSLY[i,3] <- current_DALY_var_DRC$DRC_MR[i]* (1+spoilage_change_DRC_MR)*VSLY_data[3,3]
  DRC_vac_VSLY[i,4] <- current_DALY_var_DRC$DRC_PCV[i]* (1+spoilage_change_DRC_PCV)*VSLY_data[3,4]
  DRC_vac_VSLY[i,5] <- current_DALY_var_DRC$DRC_Meningitis[i]* (1+spoilage_change_DRC_MenA)*VSLY_data[3,5]
  DRC_vac_VSLY[i,6] <- current_DALY_var_DRC$DRC_Rotavirus[i]* (1+spoilage_change_DRC_Rota)*VSLY_data[3,6]
  DRC_vac_VSLY[i,7] <- current_DALY_var_DRC$DRC_YF[i]* (1+spoilage_change_DRC_YF)*VSLY_data[3,7]
}
...
Annualized_NGA_ALT_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_NGA_ALT_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_NGA_ALT_vac_VSLY)){
  Annualized_NGA_ALT_vac_VSLY[1,i] <- NPV_NGA_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_NGA_ALT_vac_VSLY <- as.data.frame(Annualized_NGA_ALT_vac_VSLY)
...
Annualized_MWI_ALT_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_MWI_ALT_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_MWI_ALT_vac_VSLY)){
  Annualized_MWI_ALT_vac_VSLY[1,i] <- NPV_MWI_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_MWI_ALT_vac_VSLY <- as.data.frame(Annualized_MWI_ALT_vac_VSLY)
...
Annualized_DRC_ALT_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_DRC_ALT_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_DRC_ALT_vac_VSLY)){
  Annualized_DRC_ALT_vac_VSLY[1,i] <- NPV_DRC_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_DRC_ALT_vac_VSLY <- as.data.frame(Annualized_DRC_ALT_vac_VSLY)
...
Annualized_ALT_vac_VSLY <- matrix(ncol = 8, nrow = 1)
colnames(Annualized_ALT_vac_VSLY) <- c("Annualized_VacVSLY_HepA&HiB", "Annualized_VacVSLY_HPV","Annualized_VacVSLY_MR","Annualized_VacVSLY_PCV","Annualized_VacVSLY_Meningitis","Annualized_VacVSLY_Rotavirus","Annualized_VacVSLY_YF","Annualized_VacVSLY_Overall")
for (i in 1: ncol(Annualized_ALT_vac_VSLY)){
  Annualized_ALT_vac_VSLY[1,i] <- NPV_vac_VSLY [1,i]/vaccine_annuity_factor
}

Annualized_ALT_vac_VSLY <- as.data.frame(Annualized_ALT_vac_VSLY)
...
vac_DG_NGA_COI_result <- Annualized_NGA_DG_vac_COI$Annualized_VacCOI_Overall
vac_DG_NGA_VSL_result <- Annualized_NGA_DG_vac_VSL$Annualized_VacVSL_Overall
vac_DG_NGA_VSLY_result <- Annualized_NGA_DG_vac_VSLY$Annualized_VacVSLY_Overall
...
vac_NGA_COI_result <- Annualized_NGA_ALT_vac_COI$Annualized_VacCOI_Overall
vac_NGA_VSL_result <- Annualized_NGA_ALT_vac_VSL$Annualized_VacVSL_Overall
vac_NGA_VSLY_result <- Annualized_NGA_ALT_vac_VSLY$Annualized_VacVSLY_Overall
...
PVSYS_NGA_NB_COI_results[j] <- vac_NGA_COI_results[j] - vac_NGA_total_cost_results[j] - total_PVSYS_NGA_totalcost_results[j] + total_PVSYS_NGA_eleccostaverted_results[j] + total_PVSYS_NGA_envbenefit_results[j] - total_PVSYS_NGA_fridgecost_results[j]

PVSYS_NGA_NB_VSL_results[j] <- vac_NGA_VSL_results[j] - vac_NGA_total_cost_results[j] - total_PVSYS_NGA_totalcost_results[j] + total_PVSYS_NGA_eleccostaverted_results[j] + total_PVSYS_NGA_envbenefit_results[j] - total_PVSYS_NGA_fridgecost_results[j]

PVSYS_NGA_NB_VSLY_results[j] <- vac_NGA_VSLY_results[j] - vac_NGA_total_cost_results[j] - total_PVSYS_NGA_totalcost_results[j] + total_PVSYS_NGA_eleccostaverted_results[j] + total_PVSYS_NGA_envbenefit_results[j] - total_PVSYS_NGA_fridgecost_results[j]
...
vac_DG_MWI_COI_result <- Annualized_MWI_DG_vac_COI$Annualized_VacCOI_Overall
vac_DG_MWI_VSL_result <- Annualized_MWI_DG_vac_VSL$Annualized_VacVSL_Overall
vac_DG_MWI_VSLY_result <- Annualized_MWI_DG_vac_VSLY$Annualized_VacVSLY_Overall
...
vac_MWI_COI_result <- Annualized_MWI_ALT_vac_COI$Annualized_VacCOI_Overall
vac_MWI_VSL_result <- Annualized_MWI_ALT_vac_VSL$Annualized_VacVSL_Overall
vac_MWI_VSLY_result <- Annualized_MWI_ALT_vac_VSLY$Annualized_VacVSLY_Overall
...
vac_DG_DRC_COI_result <- Annualized_DRC_DG_vac_COI$Annualized_VacCOI_Overall
vac_DG_DRC_VSL_result <- Annualized_DRC_DG_vac_VSL$Annualized_VacVSL_Overall
vac_DG_DRC_VSLY_result <- Annualized_DRC_DG_vac_VSLY$Annualized_VacVSLY_Overall
...
vac_DRC_COI_result <- Annualized_DRC_ALT_vac_COI$Annualized_VacCOI_Overall
vac_DRC_VSL_result <- Annualized_DRC_ALT_vac_VSL$Annualized_VacVSL_Overall
vac_DRC_VSLY_result <- Annualized_DRC_ALT_vac_VSLY$Annualized_VacVSLY_Overall
...
vac_DG_COI_result <- Annualized_DG_vac_COI$Annualized_VacCOI_Overall
vac_DG_VSL_result <- Annualized_DG_vac_VSL$Annualized_VacVSL_Overall
vac_DG_VSLY_result <- Annualized_DG_vac_VSLY$Annualized_VacVSLY_Overall
...
vac_COI_result <- Annualized_ALT_vac_COI$Annualized_VacCOI_Overall
vac_VSL_result <- Annualized_ALT_vac_VSL$Annualized_VacVSL_Overall
vac_VSLY_result <- Annualized_ALT_vac_VSLY$Annualized_VacVSLY_Overall
...
library(openxlsx)
write.xlsx(Summary_table_DG, paste("Summary_table_StatusQuo_VCRC_incrvac.xlsx"))
...
library(openxlsx)
write.xlsx(Summary_table_SF, paste("Summary_table_VCRC_incrvac.xlsx"))
write.xlsx(Summary_table_PV, paste("Summary_table_PVSYS_VCRC_incrvac.xlsx"))
